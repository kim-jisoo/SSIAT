    ...
    return (
        <div className="question-margin">
            <div className="container">
                ...
                <label className="question-2-title"> 씨앗 커뮤니티에 가입하는 가장 큰 이유는 무엇인가요?</label>
                <label className="question-2-subtitle"> (해당되는 내용은 모두 체크해 주세요. 정보를 토대로 나에게 맞는 그룹과 이벤트가 추천됩니다.) </label>

                <form className="question-form">
                    <div className="question-2-form-group">     
                        <input type="checkbox"/>
            ...
            <div className="question-2-button-groups">
                <Link to="/question-1" className="question-2-arrow-button">                      
                ...
                <Link to="/login" className="question-2-right-arrow">
                    다음 질문
                    <svg xmlns="http://www.w3.org/2000/svg" width="47" height="47">
